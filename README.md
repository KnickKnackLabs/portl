...
**v0.8.12** — local-first session-share UX patch. Portl has persistent
...
`PORTL_VERSION=0.8.12` to pin a release. Use `--agent=off` to disable the
...
```bash
# mise
mise use -g github:KnickKnackLabs/portl@0.8.12
