...
**v0.10.5** — Herdr local-attach patch. Portl has persistent terminal
...
`PORTL_VERSION=0.10.5` to pin a release. Use `--agent=off` to disable the
...
```bash
# mise
mise use -g github:KnickKnackLabs/portl@0.10.5
