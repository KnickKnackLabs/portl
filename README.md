...
**v0.10.2** — Herdr local-attach patch. Portl has persistent terminal
...
`PORTL_VERSION=0.10.2` to pin a release. Use `--agent=off` to disable the
...
```bash
# mise
mise use -g github:KnickKnackLabs/portl@0.10.2
